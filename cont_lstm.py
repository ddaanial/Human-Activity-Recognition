...
model = LSTMModel(input_size=channel, hidden_size=64, num_layers=1, output_size=128)
model.to(device)
...
if channel == 3:
    print(f'Lstm WISDM Contrastive accuracy: {accuracy}')  
else:
    print(f'Lstm META_HAR Contrastive accuracy: {accuracy}')           
